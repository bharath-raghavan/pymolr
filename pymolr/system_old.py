...
class Analyze:
    ...
    def __get_frame(sele, trr_files, frame):
        if isinstance(sele, list) and len(sele) > 1:
            return [Analyze.__get_frame(s, trr_files, frame) for s in sele]
...
#         return kabsch_rmsd(pos1, pos2, self.mass, True)
    ...
    def __get_subset(self, s, frame):
            b = [frame.box[0], frame.box[1], frame.box[2]]
    ...
    def __get_images(self):
        b1, b2, b3 = self.box[0], self.box[1], self.box[2]
